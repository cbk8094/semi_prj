				...
				<div class="container">
					...
					<script>
						...
						$(function(){
							...
							function getReviewList(pageNum){
								...
								$.ajax({
									...
									success: function(res){
										...
										// let prevs = res.data.pageDTO.prevs ? '' : 'disabled';
										// let prev = res.data.pageDTO.prev ? '' : 'disabled';
										// let next = res.data.pageDTO.next ? '' : 'disabled';
										// let nexts = res.data.pageDTO.nexts ? '' : 'disabled';
										
										let pageStr = `
											<div class="paging_wrap d-flex justify-content-center">
												<ul class="pagination pagination-custom">
													<li class="page-item \${res.data.pageDTO.prevs ? '' : 'disabled' }">
														<a class="page-link" href="javascript:;" data-pagenum="\${res.data.pageDTO.startPage - 1}">
														<i class="fas fa-solid fa-angle-double-left"></i></a>
													</li>
													<li class="page-item \${res.data.pageDTO.prev ? '' : 'disabled' }">
														<a class="page-link" id="pageButton" href="javascript:;" data-pagenum="\${res.data.pageDTO.criteria.pageNum - 1}">
														<i class="fas fa-solid fa-angle-left"></i></a>
													</li>`;
													
										for (var i = res.data.pageDTO.startPage; i <= res.data.pageDTO.endPage; i++) {
											pageStr += `
												<li class="page-item \${res.data.pageDTO.criteria.pageNum == i ? 'active' : '' }">
													<a class="page-link" href="javascript:;" data-pagenum="\${i}">\${i }</a>
												</li>
											`;
										}
												
										pageStr += `<li class="page-item \${res.data.pageDTO.next ? '' : 'disabled' }">
														<a class="page-link" href="javascript:;" data-pagenum="\${res.data.pageDTO.criteria.pageNum + 1}"><i class="fas fa-solid fa-angle-right"></i></a>
													</li>
													<li class="page-item \${res.data.pageDTO.nexts ? '' : 'disabled' }">
													<a class="page-link" href="javascript:;" data-pagenum="\${res.data.pageDTO.endPage + 1}"><i class="fas fa-solid fa-angle-double-right"></i></a>
													</li>
												</ul>
											</div>
										`;
							...
							// 페이지 버튼
							$(".game_view_button_wrap").on("click", "#paging_wrap .page-link", function(){
